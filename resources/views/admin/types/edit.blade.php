    ...
    <div class="container">
        ...
        <form action="{{ route('admin.types.update', $type->id) }}" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="text" id="title" name="title" class="form-control bg-secondary" value="{{ old('title', $type->title) }}" required>

                <label for="slug">Inserisci il nuovo slug:</label>
                <input type="text" id="slug" name="slug" class="form-control bg-secondary" value="{{ old('slug', $type->slug) }}" required>
